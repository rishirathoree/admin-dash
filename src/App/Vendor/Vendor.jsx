...
const Vendor = () => {
  return (
    ...
    <div className='px-8 w-full pb-12 space-y-8'>
        ...
        {/* vendor card */}
        <div className='p-4 shadow2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 ring-1 ring-black rounded-lg space-y-2'>
        ...
        <div className='p-4 shadow2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 bg-gradient-to-tr from-bg-teal-200/50 to-bg-blue-300 ring-1 ring-black rounded-lg space-y-2'>
            <div className='flex items-start justify-between'>
                <div className='flex gap-2'>
                    <div className='w-20 h-20 bg-white rounded-lg shadow2'></div>
                    <div className='space-y-2'>
