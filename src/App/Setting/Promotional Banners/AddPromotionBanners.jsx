...
<p className='font-medium text-xsm'>Banner Image</p>
<i className='bx bx-image bx-lg p-12 rounded-lg shadow2 bg-blue-200/20 hover:bg-blue-200/50 duration-500 text-slate-300'></i>
<p className='font-light text-xsm'><b>Note</b>:Dimension should be 500Px * 300Px.</p>
</div>
</div>
...
export default AddPromotionBanners