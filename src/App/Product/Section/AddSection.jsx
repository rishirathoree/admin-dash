...
{/* Name Inpit */}
<label htmlFor="Section Name" className='w-full space-y-2'>
<p className='font-medium text-xsm'>Section Name</p>
<input type="text" placeholder='Section Name' className='ring-1 ring-black/5 rounded p-3 w-full font-lighter outline-none focus:outline-none focus:ring-1 focus:ring-black/70 duration-500 text-xsm' />
</label>   
...
<p className='font-medium text-xsm'>Section Image</p>
