          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-400 border-b border-dashed uppercase  dark:bg-gray-700 dark:text-gray-400">
              ...
              <th className="px-6 py-4">#</th>
                    ...
                    <th className="px-6 py-4">Section Image</th>
                    <th className="px-6 py-4">Total no. of categories</th>
              ...
              {dummyArray.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 cursor-pointer"><p>Cashback Offer</p></td>
                    <td className="px-6 py-4 cursor-pointer">
                        <i className='bx bx-image p-4 bx-md bg-blue-50 rounded-lg text-slate-400'></i>
                    </td>
                    <td className="px-6 py-4 cursor-pointer"><p>0</p></td>
